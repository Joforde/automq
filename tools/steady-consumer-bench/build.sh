#!/usr/bin/env bash
# Maven-free build for steady-consumer-bench.
# (If you have maven, `mvn -q clean package` produces the same jar.)
set -euo pipefail
...
FATDIR="${BUILD}/fat"
JAR="${BUILD}/steady-consumer-bench.jar"
MAIN="io.automq.bench.SteadyConsumerBench"
